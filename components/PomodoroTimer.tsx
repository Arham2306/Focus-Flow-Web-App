...
const PomodoroTimer = () => {
  ...
  return (
    <div className="fixed bottom-28 sm:bottom-10 right-4 sm:right-10 z-[100] bg-white dark:bg-slate-800 rounded-3xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)] p-6 w-[calc(100vw-2rem)] sm:w-80 border border-slate-200 dark:border-slate-700 animate-in slide-in-from-bottom-10 fade-in duration-300">
