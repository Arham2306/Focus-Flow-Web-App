...
const ProfileView: React.FC<ProfileViewProps> = ({ currentUser, tasks, darkMode, onToggleDarkMode, onLogout }) => {
  ...
  const stats = [
    ...
    { label: 'Completed', value: completedTasks, icon: 'check_circle', color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/20' },
    { label: 'Success Rate', value: `${completionRate}%`, icon: 'insights', color: 'text-primary', bg: 'bg-primary/10' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 p-8 shadow-sm flex flex-col">
            ...
            <div className="flex-1 space-y-4">
              <button className="w-full flex items-center justify-between p-4 hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-2xl border border-slate-100 dark:border-slate-800 transition-colors group">
                <div className="flex items-center gap-3">
