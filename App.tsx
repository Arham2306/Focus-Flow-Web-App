        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {activeNav === 'profile' ? (
            ...
            <DragDropContext onDragEnd={onDragEnd}>
              <div className={`h-full p-3 sm:p-4 lg:p-6 pb-24 sm:pb-32 overflow-x-auto custom-scrollbar flex transition-all ${viewMode === 'board' ? 'gap-3 sm:gap-6 items-start' : 'flex-col gap-4 sm:gap-6'}`}>
                {columns.map((col) => (
                  <Column
